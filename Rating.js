...
// import ratingEdit from "./Rating.form.js";
...
export default class Rating extends Field {
    ...
    attach(element) {
        ...
        if (!this.component.disabled) {
            for (const svg of this.refs.rating.children) {
                svg.addEventListener("click", () => {
                    clearRating(this.refs.rating.children, this.component.unfilledColor);
...
// Formio.Components.components.rating.editForm = ratingEdit;
